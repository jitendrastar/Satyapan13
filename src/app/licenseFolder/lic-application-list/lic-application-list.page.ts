...
@Component({
  selector: "app-lic-application-list",
  templateUrl: "./lic-application-list.page.html",
  styleUrls: ["./lic-application-list.page.scss"],
})
export class LicApplicationListPage {
  val: any = "1";
  checkedFlag: any = 0;
  checkedList: any;
  ...
  ionViewWillEnter() {
    ...
    this.getPreVerificationAssignListMobile(
      this.roleId,
      this.userid,
      this.clickOpt
    );
