...
@Component({
  selector: "app-assign-submission",
  templateUrl: "./assign-submission.page.html",
  styleUrls: ["./assign-submission.page.scss"],
})
export class AssignSubmissionPage {
  farmerPhoto: any;
  farmerName: any;
  schemeName: any;
  schemeNameHnd: any;
  ...
  constructor(
    ...
    this.listDeatailForAssign = JSON.parse(
      this.route.snapshot.paramMap.get("dataForAs")
    );
