...
@Component({
    selector: "app-diggi-pre-verification",
    templateUrl: "./diggi-pre-verification.page.html",
    styleUrls: ["./diggi-pre-verification.page.scss"],
})
export class DiggiPreVerificationPage implements OnInit {
    ...
    submitMainData() {
        if (this.lat == null) {
            ...
            if (this.httpClient.currentLanguage == "english") {
                this.httpClient.showToast(
                    "Please enter the Suitable khasara for diggi"
                );
            } else {
                this.httpClient.showToast("कृपया डिग्गी के लिए उपयुक्त खसरा दर्ज करें");
            }
        } else if (
